...
tl.from(".about-el-btn", {
    ...
    duration: 1,
    ease: "back.out(1.7)"
}).from(".element-col-text", {
    opacity: 0,
    y: -20,
    duration: 1
}, "-=0.5").from(".btn-gradient-2", {
    opacity: 0,
    y: -20,
    duration: 1
}, "-=0.5");
...
tl2.from(".element-service-title", {
    opacity: 0,
    y: -20,
    duration: 1
...
tl3.from(".element-portfolio-text", {
    opacity: 0,
    marginTop: -30,
    duration: 1
}).from(".widget-img-circle", {
    y: 180,
    duration: 1.5
}, "-=1");
...
tl5.from(".choose-us-widget-img", {
    opacity: 0,
    x: -150,
    duration: 1.5
}).from(".choose-us-shape-ani-1", {
    opacity: 0,
    y: 110,
    duration: 1
}, "-=0.6").from(".choose-us-shape-ani-2", {
    opacity: 0,
    y: 50,
    duration: 1
}, "-=0.6").from(".choose-us-shape-ani-3", {
    opacity: 0,
    x: -110,
    duration: 1
}, "-=0.6");
...
tl6.from(".pricing-title-img", {
    opacity: 0,
    duration: 1
}).from(".pricing-title-ani", {
    opacity: 0,
    duration: 1.5
}, "-=0.5");
...
tl7.from(".our-pricing-card-1", {
    opacity: 0,
    x: 100,
    duration: 1.4
}).from(".card-price-1-ani", {
    opacity: 0,
    y: -50,
    duration: 1.4
}, "-=1.2");
...
tl8.from(".our-pricing-card-2", {
    opacity: 0,
    scale: 0.8,
    duration: 1.4
}).from(".card-price-2-ani", {
    opacity: 0,
    y: -50,
    duration: 1.4
}, "-=0.9");
...
tl9.from(".our-pricing-card-3", {
    opacity: 0,
    x: -100,
    duration: 1.4
}).from(".card-price-3-ani", {
    opacity: 0,
    y: -50,
    duration: 1.4
}, "-=1.2");
...
tl10.from(".testimonial-title-ani", {
    opacity: 0,
    y: -50,
    duration: 1.4
}).from(".testimonial-carousel-ani", {
    opacity: 0,
    scale: 0.8,
    duration: 1.4
}, "-=0.4").from(".testimonial-btns-ani", {
    opacity: 0,
    y: -10,
    duration: 1
});
...
const carouselTesChildrens = [
    ...carouselTes.children
];
let isDraggingTes = false, startX2, startScrollLeft2;
let cardPerView2 = Math.round(carouselTes.offsetWidth / firstCard);
carouselTesChildrens.slice(-cardPerView2).reverse().forEach((card)=>{
...
const infiniteScroll2 = ()=>{
    if (carouselTes.scrollLeft === 0) {
        ...
        carouselTes.scrollLeft = carouselTes.scrollWidth - 2 * carouselTes.offsetWidth;
        carouselTes.classList.remove["no-transition"];
    } else if (Math.ceil(carouselTes.scrollLeft) === carouselTes.scrollWidth - carouselTes.offsetWidth) {
        carouselTes.classList.add["no-transition"];
...
},{}]},["j9r0q","ebWYT"], "ebWYT", "parcelRequiree837")
